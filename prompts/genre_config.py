...
GENRE_PROFILES: Dict[str, dict] = {
    "research_introduction": {
        ...
        "structure_guide": (
            ...
            "  → Clinical gaps (why existing diagnostic or therapeutic approaches fall short)\n"
            "  → Emerging approach (biomarkers, new data modality, or methodology that\n"
            "    could address these gaps)\n"
            "  → Prior evidence (what has been tried, what worked, what didn't)\n"
